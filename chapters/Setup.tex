...
\begin{itemize}
	\item \textbf{Material:} The team must send the digital material from the poster to \abb{OC} one day before the presentation. The material will be made available online for other teams.
	...
	\item \textbf{Organization:} It is the responsibility of the \abb{OC} and the \abb{LOC} to organize catering and location. This includes:
		\begin{itemize}
			...
			\item Inviting officials, sponsors, \abb{LOC}, and trustees to the event.
		\end{itemize}
