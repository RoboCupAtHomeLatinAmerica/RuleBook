...
\begin{scorelist}
	...
	\scoreitem[5]{100}{Pick the target object (The object cannot be touching the shelf and remain in the robot's possession for at least one second).}
	...
	\penaltyitem[5]{50}{Drop the target object. (Only applied if the robot picked up the object)}
\penaltyitem[10]{10}{Drop any other objects.}
\end{scorelist}
