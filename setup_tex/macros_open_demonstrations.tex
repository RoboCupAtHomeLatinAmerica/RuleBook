...
\newcommand{\OpenDemonstrationTask}[2] {
  \begin{enumerate}%
    \item \textbf{Setup:} The team has a maximum of 1 minute for setup.%
    \item \textbf{Pitch and demonstration:} The team has a maximum of \timing{#1 minutes} for pitch and demonstration.%
