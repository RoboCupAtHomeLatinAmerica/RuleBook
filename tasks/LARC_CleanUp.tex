...
\small\begin{scorelist}
	...
	\scoreitem[6]{250}{Place an object at the appropriate location}
	\scoreheading{Bonus Rewards}
	\scoreitem{250}{Moving a \emph{tiny} object}
	\scoreitem{250}{Moving a \emph{heavy} object}	
	\scoreheading{Regular Penalties}
	\penaltyitem[6]{100}{Place an object at the wrong location}	
	\scoreheading{Deus ex Machina Penalties}
	\penaltyitem[6]{150}{Physically interacting with object}	
	\penaltyitem[6]{50}{Guiding the robot near an object to be moved}
	\penaltyitem[6]{50}{Telling where an object can be found}
	\penaltyitem[6]{50}{Telling robot which category an object is or where to place it}
	\penaltyitem[6]{50}{Pointing out object to be moved}
\end{scorelist}
\clearpage
