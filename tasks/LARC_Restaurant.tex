...
\small\begin{scorelist}
	...
	\scoreitem[2]{200}{Detect calling or waving customer (per order).}
	\scoreitem[2]{200}{Reach a customer's table without prior guidance/training (per order).}
	\scoreitem[2]{600}{Take and serve an order.}

	\scoreheading{Bonus Rewards}
	\scoreitem[2]{100}{Use an unattached tray to transport (per order).}
