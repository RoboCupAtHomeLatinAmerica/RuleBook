...
In order to participate, a team must answer the \CFP{} announced on the \AtHome{} mailing list by sending in their \Application{}. During \Application{}, the team must indicate which sub-league it wishes to participate in. This indication does not guarantee participation in the selected sub-league. It will be up to the OC to decide which sub-league the team will participate in. Then, they need to be selected in the \Qualification{} phase and finally, complete their \Registration{}.
...
The \TeamVideo{} should show that the team has a running robot platform that is able to, at least partly, solve a tests in this rulebook. The video should be self-explanatory and designed for a general audience. Any editing, e.g. speed up, needs to be indicated. The video should not exceed \SI{10}{\minute} and needs to be publicly uploaded.
