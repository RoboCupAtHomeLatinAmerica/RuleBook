...
The robot retrieves and serves orders to several customers in a real restaurant.

\begin{itemize}
	\item For the sub-league A, the environments is previously unknown to the robot.
	\item For the sub-league B, the environments is previously known to the robot.
\end{itemize}
...
\begin{enumerate}
	...
	\item The robot takes the customer's order, place the order, and deliver it.
...
\begin{itemize}[nosep]
	...
	\item \textbf{2 hours before the test:} Select 5 volunteers. 
\end{itemize}
