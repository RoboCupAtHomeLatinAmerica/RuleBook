...
<<<<<<< HEAD
    \item \textbf{2 hours before the test:} Define each of the operator's paths for each trial of each round.
=======
    \item \textbf{2 hours before the test:} Draw the waypoint 3 each round.
>>>>>>> 97349ad27671741becead1396a8ce95632987cbc
\end{itemize}
...
\begin{scorelist}
	...
	\scoreitem[1]{150}{Reaching waypoint 1}
	\scoreitem[1]{250}{Reaching waypoint 2}
